# builder:wstki
# 开发时间9:12,2024/2/2
# name:test_geoEncoding
# 测试腾讯地图的地理编码，其得到的坐标是GCJ02的，要转换为WGS84
import requests
import re
import math
import time
...
lon,lat = tx_geoCoordinate(addr)
print("gcj02",lon,lat)

geo84 = From_gcj02_to_wgs84().gcj02_to_wgs84(lon,lat)
print("wgs84：",geo84)
lat, lng, acc, use = bd_geoCoordinate(addr)
print("bd09",lon,lat,acc,use)
geo84 = From_bd09_to_wgs84().bd09_to_wgs84(lon,lat)
print("wgs84(bd09)",geo84)