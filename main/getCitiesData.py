...
# 爬取目的地信息(城市的POI信息)： 使用fu#!/usr/bin/env python
# # -*- coding: UTF-8 -*-
# '''
# @Project ：mafengwo_data
# @File    ：getCitiesData.py
...
# getCitiesData_DB(city_mongo)  # 若集合里面有数据，就会不爬了，重复爬取请删除数据
#
# # 爬取目的地信息(城市的POI信息)： 使用func05-getPOIID
#
# # todo 将上述爬取的对应城市信息用于爬取其前300个POI
# cityID_list = [10088]
# cities_POIs_mongo = MongoDB(dataset='地途', collection='cities_POIs')  # 新建或连接一个数据库实例
